describe("collection view - childViewOptions", function(){
  ...
  describe("when rendering and an 'childViewOptions' is provided", function(){
    var CollectionView = Backbone.Marionette.CollectionView.extend({
      childView: ItemView,
      childViewOptions: {
        foo: "bar"
  ...
  describe("when rendering and an 'childViewOptions' is provided as a function", function(){
    var CollectionView = Backbone.Marionette.CollectionView.extend({
      childView: ItemView,
  ...
  describe("when rendering and an 'childViewOptions' is provided at construction time", function(){
    var CollectionView = Backbone.Marionette.CollectionView.extend({
      childView: ItemView
    });
