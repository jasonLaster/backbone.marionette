describe("composite view - childViewContainer", function(){
  ...
  describe("when rendering a collection in a composite view with an `childViewContainer` specified", function(){
  ...
  describe("when rendering a collection in a composite view without an `childViewContainer` specified", function(){
    var CompositeView = Backbone.Marionette.CompositeView.extend({
      childView: ItemView,
      template: "#composite-child-container-template"
    });
